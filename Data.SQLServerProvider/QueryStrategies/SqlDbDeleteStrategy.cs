...
{
    public class SqlDbDeleteStrategy : DbQueryStrategyBase
    {
        public SqlDbDeleteStrategy(Type modelType) : base(modelType)
        {
        }

        public SqlDbDeleteStrategy(IDbModelStrategy modelStrategy) : base(modelStrategy)
        {
        }
